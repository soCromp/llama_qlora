...
class MultiheadLlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        print('in forward. input_ids', input_ids, 'attention mask', attention_mask)
    ...
    def prepare_inputs_for_generation(
        self, input_ids, insert_indices, past_key_values=None, attention_mask=None, inputs_embeds=None, cache_position=None, **kwargs
    ):
